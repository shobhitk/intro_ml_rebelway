...
class NeuralNetwork:
    ...
    def gradient_descent(self, x,y,lr=0.01,epochs=5):
        ...
        for epoch in range(epochs):
            ...
            objs.append((w1, b1, w2, b2))
            if epoch % 10 == 0:
                print("Epoch: ", epoch +1)
                preds = self.get_predictions(a2)
                print(self.get_accuracy(preds, y))
            
        with open("/Users/shobhitkhinvasara/Documents/model_nn.pkl", "wb") as f:
            pickle.dump(objs, f)
        return w1, b1, w2, b2        


if __name__ == "__main__":
    data = pd.read_csv("/Users/shobhitkhinvasara/Documents/GitHub/intro_ml_rebelway/mnist/train.csv")
